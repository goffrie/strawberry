...
export type StartingPhasePlayer = {
    name: string,
...
export type StartingPhase = {
    ...
    wordLength: number,
    players: Array<StartingPhasePlayer>,
};

export type HintingPhasePlayer = {
    name: string,
    hand: Hand,
    hintsGiven: number,
};
...
// cards.
export type HintingPhase = {
    phase: RoomPhase.HINT,
    players: Array<HintingPhasePlayer>,
    dummies: Array<Dummy>,
    bonuses: Array<Letter>,
    hintsRemaining: number,
};

export type RoomState = StartingPhase;
